...
namespace colors {
    ...
    inline ImVec4 accent_color = ImColor(56, 234, 126);
    inline ImVec4 logo_color = ImColor(0,255,0);
    inline ImVec4 RangeColors = ImColor(255, 127, 39);
    inline ImVec4 BoxColors = ImColor(117, 249, 77);
    inline ImVec4 LineColors = ImColor(255, 255, 255);
    inline ImVec4 DistanceColors = ImColor(255, 63, 19);
    inline ImVec4 BoneColors = ImColor(115, 251, 253);
